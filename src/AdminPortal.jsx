...
function AwardIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
        d="M12 2l2.5 4.5L19 8l-4 3 1 5-4.5-2.5L7 16l1-5-4-3 4.5-1.5L12 2z"
        stroke="currentColor"
        strokeWidth="1"
        strokeLinejoin="round"
      />
...
function ShieldIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
        d="M12 2l7 3v5c0 5-3.5 9.5-7 11-3.5-1.5-7-6-7-11V5l7-3z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto">
              Join us for the premier event connecting rail industry
              professionals, innovators, and enthusiasts.
            </p>
          </section>
